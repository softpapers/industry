...
\affiliation{%
$^1$Sapafy's SoftPaper\\
$^2$Contributor from Sapafy\\
  \email{amuda@sapafy.com}}
...
It has more properties that need to be maintained once it's created.
...
Long answer: 
  ...
  2. All classes in Java are a subclass of Object
...
ii. For it to be created, it must be stored in a temporary or permanent storage
		  
    iii. For it to be used, it must be referenced from the storage
		  
    iv. For it to be referenced, it must maintain properties to determine its uniqueness
